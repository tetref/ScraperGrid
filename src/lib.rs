...
#[derive(Debug)]
pub struct ScraperGridProcessor {
    verbose: bool,
    processed_count: usize,
}

impl ScraperGridProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting ScraperGrid processing");
    
    let mut processor = ScraperGridProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = ScraperGridProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = ScraperGridProcessor::new(false);
